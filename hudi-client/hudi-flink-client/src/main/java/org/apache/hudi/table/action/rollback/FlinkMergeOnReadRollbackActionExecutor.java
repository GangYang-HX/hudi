...
/**
 * @author: chenshizhi
 * @time: 2022/5/27 7:17 下午
 */
public class FlinkMergeOnReadRollbackActionExecutor<T extends HoodieRecordPayload, I, K, O>
    extends MergeOnReadRollbackActionExecutor<T, I, K, O> {

  private static final Logger LOG =
      LogManager.getLogger(FlinkMergeOnReadRollbackActionExecutor.class);

  public FlinkMergeOnReadRollbackActionExecutor(
