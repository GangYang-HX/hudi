...
public class FlinkMergeAndReplaceHandle<T extends HoodieRecordPayload, I, K, O>
  ...
  protected void makeOldAndNewFilePaths(String partitionPath, String oldFileName, String newFileName) {
    ...
    try {
      ...
      while (fs.exists(newFilePath)) {
        ...
        LOG.info(TraceUtils.getDataBaseFileRolloverTrace(oldPath.toString(), newFilePath.toString()));
      }
    } catch (IOException e) {
  ...
  public void finalizeWrite() {
    ...
    try {
      ...
      LOG.info(TraceUtils.getDataBaseFileDeleteTrace(oldFilePath.toString()));
    } catch (IOException e) {
      throw new HoodieIOException("Error while cleaning the old base file: " + oldFilePath, e);
    }
    try {
      fs.rename(newFilePath, oldFilePath);
      LOG.info(TraceUtils.getDataBaseFileRevertTrace(newFilePath.toString(), oldFilePath.toString()));
    } catch (IOException e) {
  ...
  public void closeGracefully() {
    ...
    try {
      ...
      try {
        ...
        LOG.info(TraceUtils.getDataBaseFileDeleteTrace(newFilePath.toString()));
      } catch (IOException e) {
