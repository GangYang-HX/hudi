...
public class HoodieWriteConfig extends HoodieConfig {
  ...
  public static final ConfigProperty<String> ROWDATA_KEYGENERATOR_CLASS_NAME = ConfigProperty
      .key("hoodie.datasource.write.rowdata.keygenerator.class")
      .noDefaultValue()
      .withDocumentation("data row Key generator class, that implements `org.apache.flink.table.data.RowData.RowDataKeyGenInterface` "
          + "extract a key out of incoming records.");
