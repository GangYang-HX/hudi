...
public class TestRowDataKeyGen {
  ...
  void testSimpleKeyAndPartition() {
    ...
    final RowDataKeyGen keyGen1 = new RowDataKeyGen(conf, TestConfigurations.ROW_TYPE);
    ...
    final RowDataKeyGen keyGen2 = new RowDataKeyGen(conf, TestConfigurations.ROW_TYPE);
  ...
  void testComplexKeyAndPartition() {
    ...
    RowData rowData1 = insertRow(StringData.fromString("id1"), StringData.fromString("Danny"), 23,
        TimestampData.fromEpochMillis(1), StringData.fromString("par1"));
    RowDataKeyGen keyGen1 = new RowDataKeyGen(conf, TestConfigurations.ROW_TYPE);
