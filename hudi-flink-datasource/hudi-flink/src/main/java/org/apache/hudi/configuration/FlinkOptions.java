...
import org.apache.hudi.commit.policy.DefaultPartitionCommitPolicy;
...
public class FlinkOptions extends HoodieConfig {
  ...
  public static final ConfigOption<Integer> READ_TASKS = ConfigOptions
      ...
      .intType()
      .noDefaultValue()
      .withDescription("Parallelism of tasks that do actual read, default is the parallelism of the execution environment for streaming "
          + "and the number of files in partitions for batch");

  public static final ConfigOption<Integer> READ_MAX_TASKS = ConfigOptions
      .key("read.max.tasks")
      .intType()
      .defaultValue(1000)
      .withDescription("Maximum parallelism of tasks that do actual read, default is 1000");
  ...
  public static final ConfigOption<Boolean> CHANGELOG_STREAM_ENSURE_ORDER = ConfigOptions
      .key("changelog.stream.ensure-order.enabled")
      .booleanType()
      .defaultValue(false)
      .withDescription("Whether order ensurement needed, should be true for changelog record or specified by users, default false");
  ...
  public static final ConfigOption<String> ROWDATA_KEYGEN_CLASS_NAME = ConfigOptions
      .key(HoodieWriteConfig.ROWDATA_KEYGENERATOR_CLASS_NAME.key())
      .stringType()
      .defaultValue(RowDataKeyGen.class.getName())
      .withDescription("Key generator class, that implements will extract the key out of incoming record");
  ...
  public static final ConfigOption<Integer> COMPACTION_MAX_MEMORY = ConfigOptions
      ...
      .intType()
      .defaultValue(61440) // default 100 MB
  ...
  public static final ConfigOption<String> PARTITION_COMMIT_POLICY_CLASS_NAME = ConfigOptions
      .key("partition.commit_policy_class")
      .stringType()
      .defaultValue(DefaultPartitionCommitPolicy.class.getName())
      .withDescription("partition commit policy class configuration, custom partition commit policy when creating partitions");

  public static final ConfigOption<String> OTHER_SETUP_OPTION_CLASS_NAME = ConfigOptions
      .key("config.other_setup_option_class")
      .stringType()
      .defaultValue("org.apache.hudi.commit.archer.configuration.BILISetupOptions")
      .withDescription("Provide custom setup options");
